...
class COCOWholeBody(BaseDetDataset):
    METAINFO = {
    ...
    def load_data_list(self):
        ...
        tar_index_map = dict()
        tar_file_paths = factory.get_tar_files_for_subsets(subset, component_groups=["images"])
        ...
        for file_path, file_offset in tqdm(tar_index_map.items(), desc=f"building data list"):
            ...
            sequence_name, sample_id = sample_name.split(".")[:2]
            anno_key = sample_id
